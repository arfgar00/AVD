function Ww = wingWeightRaymer(mywing,myairfoil,Wto,nult,Scsw)
    %input and output are in Newtons
    ...
    Ww = Wwing(Wto,nult,mywing.SREF*10.7639,mywing.AR,mywing.ct/mywing.cr,Scsw*10.7639,mywing.Lambdaout50,myairfoil.t_c);
