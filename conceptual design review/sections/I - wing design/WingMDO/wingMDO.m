function optIndex = wingMDO(x)
    ...
    [CLclean1, CDi1, Cly1, CDprofile1] = LLESwept(wing,airfoil,cruise1);
    ...
    [CLclean2, CDi2, Cly2, CDprofile2] = LLESwept(wing,airfoil,cruise2);
    ...
    %Structural weight
    Ww = wingWeightRaymer(wing,airfoil,Wto,nult,wing.SREF*0.0612);
